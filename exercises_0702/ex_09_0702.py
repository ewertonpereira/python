"""
Leia uma matriz de 3x3 elementos. Calcule ao soma dos elementos que estão abaixo da diagonal principal.
"""
...
print(f'\nA soma dos soma dos elementos que estão abaixo da diagonal principal é: {final_sum}')
